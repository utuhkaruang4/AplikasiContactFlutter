...
import 'package:utsflutter/layout/entry.dart';
import 'package:utsflutter/models/kontak.dart';
import 'package:utsflutter/helpers/dbhelper.dart';
...
class HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Kontak Dicky Shah Nur Moneka'),
